...
$sql = "SELECT id, ninventario, marca, narticulo, area, imagenmarca, imagenarticulo FROM registroequipos";
...
// Título
$pdf->Cell(0, 10, 'Registro de Inventario de Equipos de Computo', 0, 1, 'C');
